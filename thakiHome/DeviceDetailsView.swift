...
struct DeviceDetailsView: View {
    ...
    var body: some View {
        ZStack {
            ...
            ScrollView { // أضفنا ScrollView عشان الشاشة ما تنضغط
                VStack(spacing: 30) {
                    // مقبض الـ Sheet
                    Capsule()
                    ...
                    VStack(spacing: 20) {
                        ...
                        // ✅ إخفاء زر التشغيل إذا كان حساس خزان
                        if liveDevice.type != "water_sensor" {
                            ...
                            // بدلاً من زر التشغيل، نعرض معلومات إضافية للخزان
                            HStack(spacing: 20) {
    ...
    func saveChanges() {
        ...
        if liveDevice.type == "water_sensor" {
            ...
            // نحتاج دالة في ViewModel لحفظ هذه الإعدادات
