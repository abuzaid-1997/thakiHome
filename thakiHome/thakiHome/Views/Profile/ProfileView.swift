...
struct ProfileView: View {
            ...
            ZStack {
                ...
                List {
                    ...
                    Section(header: Text("Settings").foregroundColor(.textSecondary)) {
                        ...
                        // ✅ زر إدارة العائلة (الجديد)
                        NavigationLink(destination: FamilyManagementView()) {
                            Label { Text("Family & Homes").foregroundColor(.textPrimary) }
                            icon: { Image(systemName: "person.3.fill").foregroundColor(.blue) }
                        }
    ...
    // ... (باقي الدوال كما هي: fetchUserData و openEmailSupport) ...
    ...
    func openEmailSupport() {
        let email = "support@thakihome.com"
        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    faqItem(q: "How to invite family?", a: "Use the 'Family & Homes' section in your profile to send invites via email.")
                    Spacer()
                }.padding()
            }
        }
